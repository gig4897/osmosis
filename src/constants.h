...
constexpr uint16_t CLR_PHONETIC      = 0xAD75;  // ~RGB(170,174,170) bright gray for phonetic
constexpr uint16_t CLR_ENGLISH       = 0xDEDB;  // ~RGB(222,222,222) near-white for english
